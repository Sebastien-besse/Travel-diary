...
let memories = [
    Memory(title: "Golden Gate",
           ...
           localisation: CLLocationCoordinate2D(latitude: 37.8199, longitude: -122.4783)),
    Memory(
        ...
        localisation: CLLocationCoordinate2D(latitude: 37.7763, longitude: -122.4327)),
        Memory(
            ...
            localisation: CLLocationCoordinate2D(latitude: 37.7694, longitude: -122.4862)
        )
